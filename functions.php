...
add_action( 'after_setup_theme', 'wordpress_tema_setup' );
        ...
        <?php
            ...
            foreach($mypostss as $postt){
                ...
                <div class="">
                    ...
                    <p class="com"><img alt="comment-img" src="wp-content/themes/wordpress_tema/img/comment.png" class="comment-img"><?php echo ' '.$postt->comment_count ." comments" ?></p><br>
        ...
        <div class="<?php echo $className.'-posts'; ?>">
            <a href="index.php?p=<?php echo $post->ID; ?>" title="<?php the_title_attribute(); ?>">
                <div class="<?php echo $className.'-post';?>">
                    ...
                    <p class="com-post"><img alt="comment-img" src="wp-content/themes/wordpress_tema/img/comment.png" class="comment-img"><?php echo ' '.$post->comment_count; ?></p><br>
        ...
        <div class="page-posts">
            ...
            foreach($posts as $post){
                ...
                <div>
                    ...
                    <p class="post-inline"><img alt="calendar-img" src="wp-content/themes/wordpress_tema/img/calendar.png" class="comment-img"><?php echo '  '; echo the_time( 'F d, Y' ); ?></p>
                    <p class="post-inline"><img alt="author-img" src="wp-content/themes/wordpress_tema/img/author.png" class="comment-img"><?php $auth= get_user_by( 'ID', $post->post_author); echo ' '."Author: ".$auth->display_name; ?></p>
                    <p class="post-inline"><img alt="comment-img" src="wp-content/themes/wordpress_tema/img/comment.png" class="comment-img"><?php echo ' '.$post->comment_count ." comments" ?></p><br/>
                    <?php echo get_the_post_thumbnail($post->ID); ?>
...
function GetSidebarPosts($args){
    ...
    foreach($myposts as $postt) :
        ...
        <div class="sidebar-post-item">
            ...
            <p class="sidebar-com"><img alt="comment-img" src="wp-content/themes/wordpress_tema/img/comment.png" class="comment-img"><?php echo ' '.$postt->comment_count ; ?></p><br>
            <?php echo get_the_post_thumbnail($postt->ID); ?>
        </div></a>
